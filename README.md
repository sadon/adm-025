...
61:
  ...
  - [x] сделать упражнение для `-replace` : сломать машину ¯\_(ツ)_/¯ и пересоздать её
> сделал легенду - ключи утеряны.
...
65:
  ...
  > немного дополнил, но я бы сказал что для начала - это сложно, деалем простейшие модули.
66:
...
68-69:
  - [x] переформулировать задание, чтобы было понятнее

69*:
  - [х] списки модулей - где найти готовые:
  - уже разработаны
  - меньше поддерживать
...
70:
  - [x] не хватает поставки проблемы - управлять однотипными ресурсами
...
72: p75
  ...
  - [x] > Часто встречается конструкция to_set(ДРУГОЙ_ТИП)
...
73:
  - [x] пункт 1 - добавить несколько книжек
 >p85, добавлен пример на макет.
76:
  - [x] разделить на два:
  ...
  - [x] есть ссылка на практику в notes, но нет упражнения
...
87:
  - [x] пример - учебный, для поиграться и понять - нужен.
>   пример переделал
